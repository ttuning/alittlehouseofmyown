...
"C:\Program Files\SAS\Viya\SASEventStreamProcessingEngine\6.2\bin\dfesp_pi_adapter.exe" ^
   -C type=pub, url="dfESP://GPSASDVESP01:62001/datainjestion/cq1/kafka_incoming", ^ 
   transport=kafka,transportconfigfile=c:\Users\tomt1\alittlehouseofmyown\kafkapub.cfg, ^
